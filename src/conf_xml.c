...
conf_generate_default(const char *filename)
{
  ...
  fprintf(fp, "    <!-- Default logging to stdout -->\n");
  fprintf(fp, "    <file name=\"stdout\" type=\"user\" severity=\"info\" size=\"10 megabytes\"/>\n");
  fprintf(fp, "    <file name=\"stdout\" type=\"operator\" severity=\"info\" size=\"10 megabytes\"/>\n");
  fprintf(fp, "    <file name=\"stdout\" type=\"debug\" severity=\"debug\" size=\"10 megabytes\"/>\n");
  fprintf(fp, "    <file name=\"stdout\" type=\"xline\" severity=\"info\" size=\"10 megabytes\"/>\n");
  fprintf(fp, "    <file name=\"stdout\" type=\"resv\" severity=\"info\" size=\"10 megabytes\"/>\n");
  fprintf(fp, "    <file name=\"stdout\" type=\"dline\" severity=\"info\" size=\"10 megabytes\"/>\n");
  fprintf(fp, "    <file name=\"stdout\" type=\"kline\" severity=\"info\" size=\"10 megabytes\"/>\n");
  fprintf(fp, "    <file name=\"stdout\" type=\"kill\" severity=\"info\" size=\"10 megabytes\"/>\n");
  fprintf(fp, "    <!-- Optional file logging (uncomment to use) -->\n");
  fprintf(fp, "    <!--\n");
  fprintf(fp, "    <file name=\"/var/log/ircd-hybrid/userlog\" type=\"user\" severity=\"info\" size=\"10 megabytes\"/>\n");
  fprintf(fp, "    <file name=\"/var/log/ircd-hybrid/operlog\" type=\"operator\" severity=\"info\" size=\"10 megabytes\"/>\n");
  fprintf(fp, "    <file name=\"/var/log/ircd-hybrid/serverlog\" type=\"debug\" severity=\"debug\" size=\"10 megabytes\"/>\n");
  fprintf(fp, "    -->\n");
  fprintf(fp, "  </log>\n\n");

  /* Operator configuration */
  fprintf(fp, "  <!-- Operator Configuration -->\n");
  fprintf(fp, "  <oper\n");
  ...
  fprintf(fp, "  <!-- Listen Configuration -->\n");
  fprintf(fp, "  <listen\n");
  ...
  /* TLS Configuration */
  fprintf(fp, "  <!-- TLS Configuration -->\n");
  fprintf(fp, "  <tls\n");
  fprintf(fp, "    enable=\"yes\"\n");
  fprintf(fp, "    cert_file=\"/etc/ircd-hybrid/cert.pem\"\n");
  fprintf(fp, "    key_file=\"/etc/ircd-hybrid/key.pem\"\n");
  fprintf(fp, "    dh_file=\"/etc/ircd-hybrid/dh.pem\"\n");
  fprintf(fp, "    cipher_list=\"HIGH:!aNULL:!MD5\"\n");
  fprintf(fp, "    verify_mode=\"none\"\n");
  fprintf(fp, "  />\n\n");

  /* Connect Configuration */
  fprintf(fp, "  <!-- Connect Configuration -->\n");
  fprintf(fp, "  <connect\n");
  fprintf(fp, "    name=\"hub.example.com\"\n");
  fprintf(fp, "    host=\"hub.example.com\"\n");
  fprintf(fp, "    send_password=\"changeme\"\n");
  fprintf(fp, "    accept_password=\"changeme\"\n");
  fprintf(fp, "    port=\"7000\"\n");
  fprintf(fp, "    class=\"users\"\n");
  fprintf(fp, "    flags=\"tls\"\n");
  fprintf(fp, "  />\n\n");

  /* Auth Configuration */
  fprintf(fp, "  <!-- Auth Configuration -->\n");
  fprintf(fp, "  <auth\n");
  fprintf(fp, "    user=\"*@*\"\n");
  fprintf(fp, "    password=\"changeme\"\n");
  fprintf(fp, "    class=\"users\"\n");
  fprintf(fp, "    flags=\"exceed_limit\"\n");
  fprintf(fp, "  />\n\n");

  /* Cluster Configuration */
  fprintf(fp, "  <!-- Cluster Configuration -->\n");
  fprintf(fp, "  <cluster\n");
  fprintf(fp, "    name=\"hub.example.com\"\n");
  fprintf(fp, "    type=\"kline,xline,resv\"\n");
  fprintf(fp, "  />\n\n");

  /* Shared Configuration */
  fprintf(fp, "  <!-- Shared Configuration -->\n");
  fprintf(fp, "  <shared\n");
  fprintf(fp, "    name=\"hub.example.com\"\n");
  fprintf(fp, "    user=\"*@*\"\n");
  fprintf(fp, "    type=\"kline,xline,resv\"\n");
  ...
  /* Gecos Configuration */
  fprintf(fp, "  <!-- Gecos Configuration -->\n");
  fprintf(fp, "  <gecos\n");
  fprintf(fp, "    name=\"*bot*\"\n");
  fprintf(fp, "    reason=\"Bots are not allowed on this network\"\n");
  fprintf(fp, "  />\n\n");

  /* Pseudo Configuration */
  fprintf(fp, "  <!-- Pseudo Configuration -->\n");
  fprintf(fp, "  <pseudo\n");
  fprintf(fp, "    command=\"stats\"\n");
  fprintf(fp, "    name=\"stats\"\n");
  fprintf(fp, "    target=\"stats.example.com\"\n");
  fprintf(fp, "    prepend=\"\"\n");
  fprintf(fp, "  />\n\n");

  /* Kill Configuration */
  fprintf(fp, "  <!-- Kill Configuration -->\n");
  fprintf(fp, "  <kill\n");
  fprintf(fp, "    user=\"*@*.example.com\"\n");
  fprintf(fp, "    reason=\"Banned from this network\"\n");
  fprintf(fp, "  />\n\n");

  /* Deny Configuration */
  fprintf(fp, "  <!-- Deny Configuration -->\n");
  fprintf(fp, "  <deny\n");
  fprintf(fp, "    ip=\"192.168.0.0/24\"\n");
  fprintf(fp, "    reason=\"This network is not allowed\"\n");
  fprintf(fp, "  />\n\n");

  /* Exempt Configuration */
  fprintf(fp, "  <!-- Exempt Configuration -->\n");
  fprintf(fp, "  <exempt\n");
  fprintf(fp, "    ip=\"10.0.0.0/8\"\n");
  fprintf(fp, "  />\n\n");

  /* Resv Configuration */
  fprintf(fp, "  <!-- Resv Configuration -->\n");
  fprintf(fp, "  <resv\n");
  fprintf(fp, "    mask=\"*bot*\"\n");
  fprintf(fp, "    reason=\"Bots are not allowed on this network\"\n");
  fprintf(fp, "    exempt=\"*@*.example.com\"\n");
  fprintf(fp, "  />\n\n");

  /* Service Configuration */
  fprintf(fp, "  <!-- Service Configuration -->\n");
  fprintf(fp, "  <service\n");
  fprintf(fp, "    name=\"services.example.com\"\n");
  fprintf(fp, "  />\n\n");
