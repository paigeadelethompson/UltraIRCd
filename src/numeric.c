...
static const char *const replies[] =
{
  ...
  /* 002 */  [RPL_YOURHOST] = ":Your host is %s[%s/%hu], running version %s",
  ...
  /* 211 */  [RPL_STATSLINKINFO] = "%s %u %u %zu %u %zu :%ju %ju %s",
  /* 212 */  [RPL_STATSCOMMANDS] = "%s %u %zu %u %u",
  ...
  /* 220 */  [RPL_STATSPLINE] = "%c %hu %s %u %s :%s",
  /* 221 */  [RPL_UMODEIS] = "%s",
  ...
  /* 477 */  [ERR_NEEDREGGEDNICK] = "%s :You need to identify to a registered nick to join that channel.",
  /* 478 */  [ERR_BANLISTFULL] = "%s %s :Channel ban list is full",
  /* 479 */  [ERR_BADCHANNAME] = "%s :Illegal channel name",
  /* 480 */  [ERR_CANNOTKNOCK] = "%s :Cannot knock on channel: %s",
  ...
  /* 484 */  [ERR_CANNOTKICK] = "%s :Cannot kick user %s from channel (+Q)",
  ...
  /* 518 */  [ERR_NOINVITE] = "%s %s :Cannot invite to channel (+V)",
  ...
  /* 734 */  [ERR_MONLISTFULL] = "%u %s :Monitor list is full",
  /* 742 */  [ERR_MLOCKRESTRICTED] = "%s %c %s :MODE cannot be set due to the channel having an active MLOCK restriction policy",
